...
**needs_info** | issues pullrequests | maintainers past_committers | Use this command if you need more information from the submitter. We will notify the submitter and apply the needs_info label.
**!needs_info** | issues pullrequests | maintainers past_committers | If you do not need any more information and just need time to work the issue, leave a comment that contains the command `!needs_info` and the *needs_info* label will be replaced with `waiting_on_maintainer`.
